    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('Шеф', 'Шеф'), ('Оператор', 'Оператор'), ('Курьер', 'Курьер'), ('Пользователь', 'Пользователь')], default='user', max_length=20, null=True, verbose_name='Роль')),
